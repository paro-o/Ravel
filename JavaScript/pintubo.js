...
const texts = [
    {
        ...
        gradient: "linear-gradient(transparent, rgb(127, 115, 47))",
        color: "white",
    ...
    },
    {
        ...
        gradient: "linear-gradient(transparent, rgba(86, 119, 14, 0.97))",
        color: "white",
        buttonColor: "rgbargba(86, 119, 14, 0.97)",
        navColor: "rgba(86, 119, 14, 0.97)"
    }
];
